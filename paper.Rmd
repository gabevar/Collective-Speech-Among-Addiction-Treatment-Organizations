...
df <- read_csv('/Users/gabe/Documents/Classes/Second year paper/final_csv_test2.csv') %>%
  drop_na(full_text) %>%
...
# mod <- readRDS('/Users/gabe/Documents/Classes/Second year paper/model_results/final.6.rds')
```
...
p2 <- kable(table_2, col.names = c("for-profit","public",
                           "for-profit","public"),
      caption = "Table 3: Top neighboring words by keyword and ownership") %>%
  kable_classic_2() %>%
...
table <- tibble(num_services, num_domain, table) %>% pivot_longer(everything ())
...
p1 <- kable(final_table, col.names = NULL, caption = "Table 1: Descriptive characteristics of the data") %>% 
  kable_styling(full_width = FALSE) %>% 
  kable_classic_2() %>% 
  group_rows("Field level",1,2) %>% 
  group_rows("Ownership level",3,5) %>% 
  group_rows("Discursive level",6,8)
```

```{r}
mod <- readRDS('/Users/gabe/Documents/Classes/Second year paper/model_results/final.rds')
mod1 <- readRDS('/Users/gabe/Documents/Classes/Second year paper/model_results/final.1.rds')
mod2 <- readRDS('/Users/gabe/Documents/Classes/Second year paper/model_results/final.2.rds')
mod3 <- readRDS('/Users/gabe/Documents/Classes/Second year paper/model_results/final.3.rds')
mod4 <- readRDS('/Users/gabe/Documents/Classes/Second year paper/model_results/final.4.rds')
mod5 <- readRDS('/Users/gabe/Documents/Classes/Second year paper/model_results/final.5.rds')
mod6 <- readRDS('/Users/gabe/Documents/Classes/Second year paper/model_results/final.6.rds')
mod7 <- readRDS('/Users/gabe/Documents/Classes/Second year paper/model_results/final.7.rds')
mod8 <- readRDS('/Users/gabe/Documents/Classes/Second year paper/model_results/final.8.rds')
...
p3 <- kable(bic_table, col.names = c("model terms", "BIC values"), caption = "") %>% 
  kable_styling(full_width = FALSE) %>% 
  kable_classic_2()
```
